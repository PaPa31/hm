"use strict";
(self["webpackChunkhuman_and_machine"] = self["webpackChunkhuman_and_machine"] || []).push([["src_sw_js"],{
...
function swCustom(params) {
  if (params.debug) {
    console.log('[Human-and-Machine-PWA][SW]: running swCustom code', params);
  } // Cache responses from external resources


  (0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(context => {
    return [/graph\.facebook\.com\/.*\/picture/, /netlify\.com\/img/, /avatars1\.githubusercontent/].some(regex => context.url.href.match(regex));
