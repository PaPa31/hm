...
draft: false
slug: nvs-one-node-version-per-terminal-in-windows
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

I tried to configure [nvm-windows](../docs/node/nvm-windows) to automatically change the `node` version based on the folder with a specific `.nvmrc` file. But unsuccessfully. When I used to run `nvm use` the node version changed globally.
