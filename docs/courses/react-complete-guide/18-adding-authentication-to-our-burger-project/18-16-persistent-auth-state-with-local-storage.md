---
id: 18-16-persistent-auth-state-with-local-storage
title: 18.16 Persistent Auth State with localStorage
date: 2021-07-22 13:56:32
---

## `auth.js`

```jsx title="src\store\actions\auth.js" {26-28,60-65,82-102}
...
```jsx title="src\App.js" {2,10,13-14,33-39}
