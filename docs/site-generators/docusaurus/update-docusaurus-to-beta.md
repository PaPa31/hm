---
id: update-docusaurus-to-beta
title: Update Docusaurus to beta
...
> <a href='https://docusaurus.io/docs/sidebar#using-number-prefixes' class='external'>docusaurus.io: Using Number Prefixes</a>
